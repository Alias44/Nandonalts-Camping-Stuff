...
namespace Camping_Stuff
{
	...
	public class NCS_Tent : ThingWithComps
	{
		...
		protected TargetingParameters GetTargetingParameters()
		{
			return new TargetingParameters()
			{
				...
				validator = (Predicate<TargetInfo>)(t => {
					sketch.DrawGhost_NewTmp(t.Cell, Sketch.SpawnPosType.Unchanged, false, null, delegate (SketchEntity se, IntVec3 targetLoc, List<Thing> list, Map map)
					{
					...
					return sketch.Entities.TrueForAll(e => e.CanBuildOnTerrain(t.Cell, t.Map) && !e.IsSpawningBlocked(t.Cell, t.Map)) && !sketch.AnyThingOutOfBounds(t.Map, t.Cell);
				})
			};
		}
		...
		{
			this.DrawGhost_NewTmp(at, placingMode, this.Rotation);
		}
